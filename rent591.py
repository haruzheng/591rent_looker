...
# Need replace
x_curl_token = "Chexl0JG2Ri2o4BHetO3dF8gvxo1VePhv7kcj7Vt"
...
def file_write(context):
	...
	file_ptr.write(context.encode('big5','ignore').decode('big5','ignore') + '\n')
...
def get_itemdata(post_id):
	...
	file_write(ret_json['data']['title'].replace(",", "") + "," + ret_json['data']['linkInfo']['imName'] + ",'" + ret_json['data']['linkInfo']['mobile'].replace("-", "").replace(",", "#") + "'," + "https://rent.591.com.tw/home/" + str(post_id))
